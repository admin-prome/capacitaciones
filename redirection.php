...
<body>
    <div class="container" style="opacity: 0.9; padding: 20px; padding-bottom: 40px; padding-top: 30px;">
        <div class="row justify-content-center" style="margin-top: 20px;">
            <div class="col-md-6">
                <h1 style="color: #23952E; text-align: center; font-weight: 600; margin-bottom: 1rem;">
                    CURSOS
                </h1>
                <div style="background-color: #F3F3F3; border-radius: 10px; padding: 15px;">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            setTimeout(function() {
                document.getElementById('Cursos').getElementById('link').click();
            }, 2000);
        });
    </script>
</body>
